...
confusion. User-authored hooks and visualizer-generated stubs lived side by
...
We solved this by putting everything the visualizer generates into
...
└── visualizer/           # ← all visualizer-generated files
    ├── session-start.sh
    ├── pre-tool-use.sh
    ├── error-occurred.sh
    ├── ...
...
visualizer captures. All generated files live in the `.github/hooks/visualizer/`
